...
|-----------|--------|------|---------|------|------|
| Accuracy | BDT | 0.805 | **0.0265** | 0.722 | 0.843 |
| Accuracy | LR | 0.852 | 0.0001 | 0.852 | 0.852 |
| AUC | BDT | 0.767 | **0.0129** | 0.725 | 0.786 |
...
安定性の比較 (標準偏差):
          ...
          BDT                    LR
  Accuracy: ===== 0.0265      Accuracy: | 0.0001
  AUC:      === 0.0129        AUC:      | 0.0007
...
1. **BDTの識別能力は優れるが安定性に課題がある**
   - AUCはLRを0.115ポイント上回るが、ブートストラップ標準偏差が20倍大きい（0.013 vs 0.001）
